...
SELECT i_item_desc, 
               ...
               Count(*) total_cnt 
FROM   `hadoop-benchmarking01`.TPCDS_1TB.catalog_sales
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.inventory 
         ON ( cs_item_sk = inv_item_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.warehouse 
         ON ( w_warehouse_sk = inv_warehouse_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.item 
         ON ( i_item_sk = cs_item_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.customer_demographics 
         ON ( cs_bill_cdemo_sk = cd_demo_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.household_demographics 
         ON ( cs_bill_hdemo_sk = hd_demo_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.date_dim d1 
         ON ( cs_sold_date_sk = d1.d_date_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.date_dim d2 
         ON ( inv_date_sk = d2.d_date_sk ) 
       JOIN `hadoop-benchmarking01`.TPCDS_1TB.date_dim d3 
         ON ( cs_ship_date_sk = d3.d_date_sk ) 
       LEFT OUTER JOIN `hadoop-benchmarking01`.TPCDS_1TB.promotion 
     ...
     AS (SELECT d_year, 
         ...
         FROM   (SELECT d_year, 
                 ...
                 FROM   `hadoop-benchmarking01`.TPCDS_1TB.catalog_sales 
                        JOIN `hadoop-benchmarking01`.TPCDS_1TB.item 
                          ON i_item_sk = cs_item_sk 
                        JOIN `hadoop-benchmarking01`.TPCDS_1TB.date_dim 
                          ON d_date_sk = cs_sold_date_sk 
                        LEFT JOIN `hadoop-benchmarking01`.TPCDS_1TB.catalog_returns 
                 ...
                 FROM   `hadoop-benchmarking01`.TPCDS_1TB.store_sales 
                        ...
                        LEFT JOIN `hadoop-benchmarking01`.TPCDS_1TB.store_returns 
                 ...
                 FROM   `hadoop-benchmarking01`.TPCDS_1TB.web_sales 
                        ...
                        LEFT JOIN `hadoop-benchmarking01`.TPCDS_1TB.web_returns 
...
( 
                ...
                FROM            `hadoop-benchmarking01`.TPCDS_1TB.web_sales 
                LEFT OUTER JOIN `hadoop-benchmarking01`.TPCDS_1TB.web_returns 
                ON              ( 
...
SELECT Substr(r_reason_desc, 1, 20), 
               ...
               Avg(wr_fee) 
FROM   `hadoop-benchmarking01`.TPCDS_1TB.web_sales, 
       `hadoop-benchmarking01`.TPCDS_1TB.web_returns, 
       `hadoop-benchmarking01`.TPCDS_1TB.web_page, 
       `hadoop-benchmarking01`.TPCDS_1TB.customer_demographics cd1, 
       `hadoop-benchmarking01`.TPCDS_1TB.customer_demographics cd2, 
       `hadoop-benchmarking01`.TPCDS_1TB.customer_address, 
...
FROM   `hadoop-benchmarking01`.TPCDS_1TB.call_center, 
       `hadoop-benchmarking01`.TPCDS_1TB.catalog_returns, 
       `hadoop-benchmarking01`.TPCDS_1TB.date_dim, 
       `hadoop-benchmarking01`.TPCDS_1TB.customer, 
       `hadoop-benchmarking01`.TPCDS_1TB.customer_address, 
...
FROM     `hadoop-benchmarking01`.TPCDS_1TB.web_sales ws1 , 
         `hadoop-benchmarking01`.TPCDS_1TB.date_dim , 
         `hadoop-benchmarking01`.TPCDS_1TB.customer_address , 
         `hadoop-benchmarking01`.TPCDS_1TB.web_site 
...
AND      EXISTS 
         ( 
                SELECT * 
                FROM   `hadoop-benchmarking01`.TPCDS_1TB.web_sales ws2 
                WHERE  ws1.ws_order_number = ws2.ws_order_number 
                AND    ws1.ws_warehouse_sk <> ws2.ws_warehouse_sk) 
AND      NOT EXISTS 
         ( 
                SELECT * 
                FROM   `hadoop-benchmarking01`.TPCDS_1TB.web_returns wr1 
...
( 
       ...
       FROM   `hadoop-benchmarking01`.TPCDS_1TB.web_sales ws1, 
              `hadoop-benchmarking01`.TPCDS_1TB.web_sales ws2 
       WHERE  ws1.ws_order_number = ws2.ws_order_number 
       AND    ws1.ws_warehouse_sk <> ws2.ws_warehouse_sk) 
SELECT 
         Count(DISTINCT ws_order_number) AS `order count` , 
